...
Application
    porousChtMultiRegionTwoPhaseEulerFoam
...
#include "porousHeatTransferModel.H" // addtionally added for porous media library 
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
...
int main(int argc, char *argv[])
{
    ...
    #include "createFieldsPorous.H" // additionally added porous media library.
    ...
    while (runTime.run())
    {
        ...
        if (nOuterCorr != 1)
        {
            forAll(fluidRegions, i)
            {
                ...
                #include "updatePorousCorrelations.H"// addtionally added porous media library
                #include "solveFluidPorous.H" // addtionally added porous media library
            }
        }
